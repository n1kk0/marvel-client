      ...
      title: !widget.searchFilterActive ?
        ...
        TypeAheadField<MarvelSeries>(
          textFieldConfiguration: TextFieldConfiguration(
            ...
            style: TextStyle(color: Theme.of(context).primaryTextTheme.bodyText1.color, fontSize: 16, fontWeight: FontWeight.bold),
            autofocus: true,
            cursorColor: Theme.of(context).primaryTextTheme.bodyText1.color,
            decoration: InputDecoration(
              labelText: 'Search by Comic Series Title',
              counterStyle: TextStyle(color: Theme.of(context).primaryTextTheme.bodyText1.color, fontSize: 10),
              fillColor: Theme.of(context).primaryTextTheme.bodyText1.color,
